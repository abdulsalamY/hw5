...
namespace output{ 
	...
	void printEnumType(const string& name, vector<string>& values); /* Do not save the string returned from this function in a data structure as it is not dynamically allocated and will be destroyed(!) at the end of the calling scope. */
